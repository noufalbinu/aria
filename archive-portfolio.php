<?php get_header(); ?>
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/portfolio.css"/>
...
<div class="container-100">
  ...
  <div class="container-width-1100">
    ...
    <div class="gallery-filter">
      ...
      <?php 
        $args = array('taxonomy' => 'portfolio','orderby' => 'name', 'order'   => 'ASC');
        $portfolios = get_categories($args);
        foreach($portfolios as $portfolio) {
          echo '<span class="filter-item" data-filter="' . $portfolio->term_id . '" >' . $portfolio->name . '</span>';
        } 
       ?> 
		</div>   
    <!--Gallary Images-->
      <div class="masonry">
          ...
          $categoriess = get_terms( get_the_ID(), 'portfolio' );
